...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gallery_album', (
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='evento', null=True, to=orm['events.Event'])),
    ...
    models = {
        ...
        u'gallery.album': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'evento'", 'null': 'True', 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
